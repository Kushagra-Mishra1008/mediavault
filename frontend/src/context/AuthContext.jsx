...
// Reads an existing, unexpired token synchronously on first render, so a
// signed-in user never sees a logged-out frame or a loading screen.
// exp is in seconds (JWT spec); Date.now() is milliseconds.
